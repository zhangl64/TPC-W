...
public class TraceSim
{
	...
	//lei_02, add rbe.
    public void run(RBE rbe, Vector<EB> ebs, long start, long term)
    throws InterruptedException {
        ...
        while (true) {
		   ...
		   //lei_open
		   System.out.println("Starting rampEBs."); //never show
		   
                RBE.rampEBs(rbe, ebs, prevCount, count, t, term);//lei_02, add rbe 
                if (t >= term) {
                    return;
                }
                prevCount = count;
